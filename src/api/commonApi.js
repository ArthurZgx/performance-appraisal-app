...
commonApi.create = function(tableName, params) {
 ...
 * 删除一条信息
 */
commonApi.delete = function(tableName, id) {
...
//获取一条数据
commonApi.getOne = function(tableName, id) {
  // params.filters?params.filters = JSON.stringify(params.filters):'';
 ...
 * @param params：参数
 */
commonApi.edit = function(tableName, id, params) {
...
//获取直线上级
commonApi.getSuper = function(id){
  "use strict";
  return request('extends/hmPersonnelSuperiorLine', {
    method: 'post',
    headers: { 'Content-Type': 'application/x-www-form-urlencoded;charset=UTF-8' },
    data: {
      userId:id
...
/**
   * 获取人员部门树形结构
 */
commonApi.getTree = function() {
  return request.post('return_department_people', {
    headers: { 'Content-Type': 'application/x-www-form-urlencoded;charset=UTF-8' }
  })
}
